...
Class notes from BYU CS 260 (Web Programming). Moved out of README.md.
...
- The internet: IP addresses, TCP/IP layers, routers, packets
- Web servers: monolithic, microservices, gateways / reverse proxies
- Domain names, DNS records (A, CNAME, NS, SOA), TTL
- Caddy: reverse proxy, HTTPS certificate rotation via Let's Encrypt
- HTTPS and TLS: how secure connections are negotiated
- HTML: elements, tags, attributes, common elements, special characters, versions
- CSS: positioning (float, margin, translate, flex, grid), design properties, units
- JavaScript
- React: components, JSX, hooks, single-page applications
- Node.js and NPM
- MongoDB: collections, querying, shell interaction
- WebSockets: real-time bidirectional communication
- Simon assignments: Login, DB, Service, React, WebSocket

## Future Work

See [Notes.md](Notes.md) for planned improvements to the app (search bar, user-submitted classes, UI modernization, unit tests).
